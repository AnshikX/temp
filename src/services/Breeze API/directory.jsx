...
export const directoryDeleteDestroy = async (projectId) => {
  ...
  let url = `${import.meta.env.VITE_BREEZE_API}api/directory/${projectId}/delete`;
...
export const directoryGetRetrieve = async (projectId, target_id) => {
  const localInstance = duplicateInstance(moduleInstance);
  let url = `${import.meta.env.VITE_BREEZE_API}api/directory/${projectId}/get`;
...
export const directoryGetCodeRetrieve = async (fileId, projectId) => {
  const localInstance = duplicateInstance(moduleInstance);
  let url = `${import.meta.env.VITE_BREEZE_API}api/directory/${projectId}/get-code/${fileId}`;
...
export const directoryMoveFileCreate = async (projectId) => {
  const localInstance = duplicateInstance(moduleInstance);
  let url = `${import.meta.env.VITE_BREEZE_API}api/directory/${projectId}/move-file`;
...
export const directoryRenameFileCreate = async (projectId) => {
  const localInstance = duplicateInstance(moduleInstance);
  let url = `${import.meta.env.VITE_BREEZE_API}api/directory/${projectId}/rename-file`;
