...
export const clearAuthSessionSwaggerPetstoreOpenAPI30 = async () => {};

export const petstoreAuthLogin = async () => {
  return new Promise((resolve, reject) => {
    const scope = encodeURIComponent("write:pets read:pets");
    const authUrl = `https://petstore3.swagger.io/oauth/authorize?client_id=${import.meta.env.VITE_CLIENT_ID_SWAGGER_PETSTORE___OPENAPI_3_0}&redirect_uri=&response_type=token&scope=${scope}`;
